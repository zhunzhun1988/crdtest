...
import (
	...
	internalinterfaces "github.com/zhunzhun1988/crdtest/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/zhunzhun1988/crdtest/pkg/client/listers/patrick.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PatrickV1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PatrickV1().Clusters(namespace).Watch(options)
			},
		},
		&patrickcomv1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&patrickcomv1.Cluster{}, f.defaultInformer)
}
